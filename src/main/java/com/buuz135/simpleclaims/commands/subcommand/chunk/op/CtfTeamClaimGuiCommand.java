...
public class CtfTeamClaimGuiCommand extends AbstractAsyncCommand {

    private final CtfTeam team;

    public CtfTeamClaimGuiCommand(CtfTeam team) {
        ...
        if (sender instanceof Player player) {
            ...
            if (ref != null && ref.isValid()) {
                ...
                return CompletableFuture.runAsync(() -> {
                    ...
                    ClaimManager.getInstance().getAdminUsageParty().put(playerRef.getUuid(), party.getId());
